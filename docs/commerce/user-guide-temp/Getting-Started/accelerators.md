...
> **Note**: Users who want to build their store from scratch are recommended to review the [Store Setup Overview](../store-setup-overview/).
...
* [Using the Minium Accelerator to Jump Start a B2B Store](../using-the-minium-accelerator-to-jump-start-a-b2b-store/)
